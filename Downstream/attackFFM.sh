...
#SBATCH --nodelist=elab-gpu-ubuntu06              
#SBATCH --gres=gpu:1                
#SBATCH --mem=20G                     
...
LOG_NAME="attackFFM_SHDR_robustSubspace_correcttrainset_pixcons"
...
srun $PYTHON_EXEC -u /path/to/workspace/code/DeepUWF/DP/dp_fl_train.py  --modedp "attack"  --config "/path/to/workspace/code/DeepUWF/DP/dp_fl_config_attack.yaml" 
# ---- run ----
