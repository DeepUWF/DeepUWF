...
LOG_NAME="testDP_SHDR_adamw_nodp_model_standalone_seed3"
...
#MODEL_DIR="/path/to/workspace/weights/DeepUWFDP/DR_NoDPBaseline_adamw"
#MODEL_DIR="/path/to/workspace/weights/DeepUWFDP/SHDR_ep32_adamw"
#MODEL_DIR="/path/to/workspace/weights/DeepUWFDP/SHDR_ep8_adamw"
#MODEL_DIR="/path/to/workspace/weights/DeepUWFDP/SHDR_ep1_adamw"
#MODEL_DIR="/path/to/workspace/weights/DeepUWFDP/SHDR_NoDPBaseline_adamw_savegrad"
#MODEL_DIR="/path/to/workspace/weights/DeepUWFDP/SHDR_NoDPBaseline_adamw_seed4"

MODEL_DIR="/path/to/workspace/weights/DeepUWFDP/SHDR_NoDPBaseline_adamw_seed3"

for EP in $(seq 0 7); do
    ...
    srun "$PYTHON_EXEC" -u /path/to/workspace/code/DeepUWF/DP/dp_fl_train.py \
        --modedp "test" \
        --config "/path/to/workspace/code/DeepUWF/DP/dp_fl_config_test.yaml" \
