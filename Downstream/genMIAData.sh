...
#SBATCH --nodelist=elab-gpu-ubuntu05               
#SBATCH --gres=gpu:1                
#SBATCH --mem=20G                     
...
LOG_NAME="genMIAData_SHDR_dp1_trainset"
LOG_NAME="genMIAData_SHDR_dp32_trainset"
LOG_NAME="genMIAData_SHDR_dp8_trainset"
LOG_NAME="genMIAData_SHDR_npdpbaseline_trainset"
...
srun $PYTHON_EXEC -u /path/to/workspace/code/DeepUWF/DP/dp_fl_train.py  --modedp "softmax"  --config "/path/to/workspace/code/DeepUWF/DP/dp_fl_config_mia.yaml" 
# ---- run ----
