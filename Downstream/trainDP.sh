...
LOG_NAME="trainDP_adamw_dp1_SHDR_seed1"
...
srun $PYTHON_EXEC -u /path/to/workspace/code/DeepUWF/DP/dp_fl_train.py  --modedp "train"  --config "/path/to/workspace/code/DeepUWF/DP/dp_fl_config.yaml" 
# ---- run ----
