...
#LOG_NAME="trainUnet_SHDR_random_attack_results_robust_subspace_correcttrainset_pixcons"
LOG_NAME="testUnet_SHDR_random_attack_results_robust_subspace_correcttrainset_pixcons"
...
#srun $PYTHON_EXEC -u /path/to/workspace/code/DeepUWF/pairAttack/Pytorch-UNet/trainHierar.py


srun $PYTHON_EXEC -u /path/to/workspace/code/DeepUWF/pairAttack/Pytorch-UNet/testHierar.py \
  --load "/path/to/workspace/program_output/DeepSteg/SHDR_random_attack_results_robust_subspace_correcttrainset_pixcons/unet_hierar/best_checkpoint.pth"
