...
LOG_NAME="trainSHDR_random_attack_results_robust_subspace_trainset_pixcons"
...
srun $PYTHON_EXEC -u /path/to/workspace/code/DeepUWF/DP/dp_fl_train_encrypt.py  --modedp "train"  --config "/path/to/workspace/code/DeepUWF/DP/dp_fl_config_baseline_encrypt.yaml" 
# ---- run ----
